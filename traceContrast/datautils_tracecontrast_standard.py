...
def load_SCN():
    ...
    scn_data_path = f'X:/Peace Lab/RafaTest/RafaCode/TraceContrast/all_neuron_{date}.mat'
    ...
    train = np.reshape(trace, (trace.shape[0], 24, 200)) # standard 24 200, time sample 24 100, non scn 12 200
